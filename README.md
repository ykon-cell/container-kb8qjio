...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kb8qjio.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kb8qjio.containers.anotherwebservice.com/
...
```
git clone git@github.com:ykon-cell/container-kb8qjio.git
cd container-kb8qjio
```
...
```
docker attach container-kb8qjio
```
